...
主要な6つのコマンドを、毎回同じ5項目で説明します：何をするか / 何を読むか / 何を書くか / いつ止まるか / 単独で叩きたいとき。このほかに直接叩けるものとして、`/bank-id`（このページ末尾）と、`/hora-spec` が走らせる7つのステージ skill（`/hora-spec` の節に名前があります）があります。
