...
**仕様書を書く SKILL。** 版の仕様書をあなたと対話しながら書き、実作業を行う7つのステージ SKILL を順に呼びます。

| | |
|---|---|
| **読む** | `specs/`、`.hora/spec/`、そしてあなたが話したこと |
| **書く** | `specs/<version>/spec.md` と、その版の機能ファイル — **1節ずつ、書き込む前に全文を提示し、承認されてから書き込みます。** ほかに `.hora/spec/<version>/_stages.md` と `.hora/questions/` |
