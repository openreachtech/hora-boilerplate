...
```
1. Confirm the environment      backend-renchan-build-e2e-test-environment
2. Unit suites, per repository  core-test-execution and friends
3. The scenario list            frontend-e2e-test-specification
4. The acceptance review        frontend-acceptance-review
5. UX findings                  frontend-uiux-audit
```
